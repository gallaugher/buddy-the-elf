...
buddySounds = ["my-names-buddy.wav", "christmas-cheer-sing-loud.wav",  "its-great-to-meet-you.wav", "i-just-like-to-smile.wav", "santas-coming-so-much-to-do.wav", "you-sit-on-a-throne-of-lies.wav"]
    ...
    for i in range(len(touchpad)):
        if touchpad[i].value:
            if i == 2:
                ...
                soundToPlay = random.randint(0, len(buddySounds))
